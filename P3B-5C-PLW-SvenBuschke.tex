...
\def\maketitle{%
  ...
  \begin{center}\leavevmode
       \normalfont 	\includegraphics[width=.96\columnwidth]{Deckblatt-P3B-signed-20210823.pdf}
       \newpage
...
Das charakteristische Spektrum werden gebildet von charakteristischen Wellenlängen $\lambda$ bei bestimmten Übergängen. Es gilt $E = \hbar \fraq{c}{\lambda}$.
